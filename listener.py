...
# listener.py — Unified LPR Service with Motion Detection
import os
import cv2
import json
import math
...
def process_video(video_path):
    ...
    while True:
        ...
        if motion_level < MOTION_THRESHOLD:
            logging.info(f"[Frame {frame_id}] Skipped (motion={motion_level:.4f}) below {MOTION_THRESHOLD}")
            continue
